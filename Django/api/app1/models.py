...
class Product(models.Model):
    ...
    def __str__(self):
        return self.name + "| r{self.brand} |" + str(self.price)
...
class Order(models.Model):
    ...
    tax_price = models.DecimalField(max_digits=12,decimal_places=2,blank=True,null=True)
    ...
    delever_at= models.DateTimeField(auto_now_add=False,null=True,blank=True)
